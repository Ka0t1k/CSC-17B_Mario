...
void MainWindow::createActions(){
    ...
    weatherStationAction = new QAction(tr("&Weather"), this);
    weatherStationAction->setShortcut(tr("Ctrl+w"));
    weatherStationAction->setStatusTip(tr("Weather"));
...
void MainWindow::createMenus(){
   ...
   //Add Weather menu
    weatherMenu = menuBar()->addMenu(tr("&Weather"));
    weatherMenu->setToolTip("Weather UDP Datagram");
