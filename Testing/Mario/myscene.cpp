...
MyScene::MyScene(QObject *parent) :
  ...
  , m_velocity(4) //The distance mario moves: expressed in pixels
  , m_skippedMoving(0)
  , m_groundLevel(0)
  , m_minX(0)
  , m_maxX(0)
  ...
  , m_jumpHeight(180)
  , m_fieldWidth(5500)// length of the scene
  , m_player(0)
  , m_sky(0)
  , m_Scene(0)
  , m_grass(0)
...
void MyScene::movePlayer()
{
    ...
    const int rightBorder = 650 - m_player->boundingRect().width(); // How far mario can walk  right before screen moves
    const int leftBorder = 150; // How far mario can walk left before screen moves
...
{
    setSceneRect(0,0,800,340);// scene window size
    m_groundLevel = 300;
