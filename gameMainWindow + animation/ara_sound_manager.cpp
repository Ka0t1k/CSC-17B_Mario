    ...
    ui(new Ui::Ara_Sound_Manager)
{
    ...
    level1->setMedia(QUrl("qrc:/sounds/audio/level1.mp3"));

    this->soundPlayer = new QMediaPlayer;
    soundPlayer->setMedia(QUrl("qrc:/sounds/audio/ThemeSong.mp3"));
